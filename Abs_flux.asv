...
clear
close all
addpath('C:\Users\Kristofer Pedersen\Documents\MATLAB\DAY11\ZI_NG','C:\Users\Kris\Documents\DTU\Semester 4\Mathematical and Numerical Methods in Earth and Space Physics\Mathematical-Methods\ZI_NG')
...
% hastigheds_aendring_y(i)=A2(i,4)-B2(i,4)
% end
...
subplot(2,1,2)
% plot is-tykkelsen gennem flux linien
plot(profilv_y*0.001,profilv_dv_x*0.001,'.-')
xlabel('afstand in km')
